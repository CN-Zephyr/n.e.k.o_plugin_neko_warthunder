...
1. Keep the standalone source and host-integrated copy aligned, run the `579/579` logic check, full pytest, `tools/preflight.py --run`, and `tools/release_readiness.py --run`, then build and validate the artifact with `tools/build_release_candidate.py`.
